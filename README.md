...
4. Op `login.html` kun je ook op **Herstel app (cache legen)** klikken (geen DevTools nodig).
5. Lukt inloggen niet of zie je nog steeds oud scherm? Open direct `https://<jouw-username>.github.io/<repo>/force-update.html` en klik **Nu herstellen**.
6. Zie je daarna nog oud scherm? Open browser DevTools → Application/Storage en verwijder **Site data** één keer voor deze URL.
